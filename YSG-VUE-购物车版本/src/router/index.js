...
import shoppingCart from '../components/communityLife/shoppingCart.vue'
/**
 *促销优惠
 */
...
export default new Router({
    routes: [
        ...
        {path: '/buy',name: 'buy',component: buy},//购物详情2
        {path: '/shoppingCart',name: 'shoppingCart',component: shoppingCart},//购物车结算
