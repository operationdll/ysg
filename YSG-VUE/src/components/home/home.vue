<template>
	<div class="home">
		<section class="index">
			...
			<!--导航菜单-->
      <div class="home-bnt-left" @click="goBack" v-if="pageFlag">
          <span class="home-back"></span>
      </div>
      <div class="home-bnt-left" @click="showCenter" v-else>
  ...
  methods: {
    ...
    goCaocao(){
      ...
      this.$store.dispatch("createCCSign", params).then(res => {
        ...
        let url = "https://sandbox-mobile.caocaokeji.cn/enterprise-travel/home?client_id="+params.client_id+"&user_type=1&ext_user_id="+params.hotelid+"&sign="+sign+"&timestamp="+timestamp;
